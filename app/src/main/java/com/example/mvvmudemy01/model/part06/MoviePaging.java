...
public class MoviePaging extends BaseObservable implements Parcelable {
    ...
    public final static Creator<MoviePaging> CREATOR = new Creator<MoviePaging>() {


        @SuppressWarnings({
                "unchecked"
        })
        public MoviePaging createFromParcel(Parcel in) {
            return new MoviePaging(in);
        }

        public MoviePaging[] newArray(int size) {
