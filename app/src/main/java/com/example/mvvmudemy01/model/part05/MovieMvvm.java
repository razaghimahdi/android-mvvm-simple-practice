...
public class MovieMvvm extends BaseObservable implements Parcelable
{
    ...
    public final static Creator<MovieMvvm> CREATOR = new Creator<MovieMvvm>() {


        @SuppressWarnings({
                "unchecked"
        })
        public MovieMvvm createFromParcel(Parcel in) {
            return new MovieMvvm(in);
        }

        public MovieMvvm[] newArray(int size) {
            return (new MovieMvvm[size]);
        }

    }
            ;

    protected MovieMvvm(Parcel in) {
